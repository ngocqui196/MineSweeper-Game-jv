public class Main {
    public static void main(String[] args) {
        ...
        final  int MAP_HEIGH = map.length;
        final int MAP_WIDTH = map[0].length;

        String[][] mapReport = new String[MAP_HEIGH][MAP_WIDTH];
        for (int yOrdinate = 0; yOrdinate < MAP_HEIGH; yOrdinate++) {
                ...
                if (curentCell.equals("*")) {
                    ...
                    for (int i = 0; i < NEIGHBOURS_ORDINATE.length; i++) {
                        ...
                        boolean isOutOfMapNeighbour = xOrdinateOfNeighbour < 0
                                ...
                                ||yOrdinateOfNeighbour == MAP_HEIGH;
